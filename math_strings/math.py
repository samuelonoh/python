...
# Return remainder of diision
print("fmod(5,4) = ", math.fmod(5,4))

# Receive a flat and return an int
...
# You canalso use base 10 like this
print("log10(1000) = ", math.log10(1000))

# We have the following trig functions
# sih(x), cos, tan, asin, acos, atan, aton2, asinh, acosh
